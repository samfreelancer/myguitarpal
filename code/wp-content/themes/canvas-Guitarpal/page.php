	...
	<div class="contentwraper">
        <div class="wrapperContent">
            <div class="mid-section">
                ...
                <div class="col-1">
                    <div class="arrow"><img src="<?php bloginfo('template_url'); ?>/images/learn-arrow.png" width="254" height="91" /></div>
                    <div class="img-box">
                ...
                <div class="col-1">
                    <div class="arrow"><img src="<?php bloginfo('template_url'); ?>/images/play-arrow.png" width="254" height="91" /></div>
                    <div class="img-box">
                ...
                <div class="col-1">
                    <div class="arrow"><img src="<?php bloginfo('template_url'); ?>/images/print-arrow.png" width="254" height="91" /></div>
                    <div class="img-box">
